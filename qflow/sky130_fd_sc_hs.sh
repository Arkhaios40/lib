...
set leffile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_hs/lef/sky130_fd_sc_hs.lef

# The SPICE netlist containing subcell definitions for all the standard cells
set spicefile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_hs/spice/sky130_fd_sc_hs.spice

# The liberty format file containing standard cell timing and function information
set libertyfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_hs/lib/sky130_fd_sc_hs__ff_n40C_1v95.lib
...
set techleffile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_hs/techlef/sky130_fd_sc_hs__nom.tlef
...
set gdsfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_hs/gds/sky130_fd_sc_hs.gds	;# GDS database of standard cells
set verilogfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_hs/verilog/sky130_fd_sc_hs.v	;# Verilog models of standard cells
