...
set leffile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_ls/lef/sky130_fd_sc_ls.lef

# The SPICE netlist containing subcell definitions for all the standard cells
set spicefile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_ls/spice/sky130_fd_sc_ls.spice

# The liberty format file containing standard cell timing and function information
set libertyfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_ls/lib/sky130_fd_sc_ls__ff_n40C_1v95.lib
...
set techleffile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_ls/techlef/sky130_fd_sc_ls__nom.tlef
...
set gdsfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_ls/gds/sky130_fd_sc_ls.gds	;# GDS database of standard cells
set verilogfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_ls/verilog/sky130_fd_sc_ls.v	;# Verilog models of standard cells
