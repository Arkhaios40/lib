...
set leffile=/usr/local/share/pdk/sky130A/libs.ref/sky130_osu_sc_12t_ls/lef/sky130_osu_sc_12t_ls.lef

# The SPICE netlist containing subcell definitions for all the standard cells
set spicefile=/usr/local/share/pdk/sky130A/libs.ref/sky130_osu_sc_12t_ls/spice/sky130_osu_sc_12t_ls.spice

# The liberty format file containing standard cell timing and function information
set libertyfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_osu_sc_12t_ls/lib/sky130_osu_sc_12t_ls.lib
...
set techleffile=/usr/local/share/pdk/sky130A/libs.ref/sky130_osu_sc_12t_ls/techlef/sky130_osu_sc_12t_ls.tlef
...
set gdsfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_osu_sc_12t_ls/gds/sky130_osu_sc_12t_ls.gds	;# GDS database of standard cells
set verilogfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_osu_sc_12t_ls/verilog/sky130_osu_sc_12t_ls.v	;# Verilog models of standard cells
