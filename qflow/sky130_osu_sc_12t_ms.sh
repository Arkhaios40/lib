...
set leffile=/usr/local/share/pdk/sky130A/libs.ref/sky130_osu_sc_12t_ms/lef/sky130_osu_sc_12t_ms.lef

# The SPICE netlist containing subcell definitions for all the standard cells
set spicefile=/usr/local/share/pdk/sky130A/libs.ref/sky130_osu_sc_12t_ms/spice/sky130_osu_sc_12t_ms.spice

# The liberty format file containing standard cell timing and function information
set libertyfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_osu_sc_12t_ms/lib/sky130_osu_sc_12t_ms.lib
...
set techleffile=/usr/local/share/pdk/sky130A/libs.ref/sky130_osu_sc_12t_ms/techlef/sky130_osu_sc_12t_ms.tlef
...
set gdsfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_osu_sc_12t_ms/gds/sky130_osu_sc_12t_ms.gds	;# GDS database of standard cells
set verilogfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_osu_sc_12t_ms/verilog/sky130_osu_sc_12t_ms.v	;# Verilog models of standard cells
