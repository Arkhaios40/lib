...
set leffile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_ms/lef/sky130_fd_sc_ms.lef

# The SPICE netlist containing subcell definitions for all the standard cells
set spicefile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_ms/spice/sky130_fd_sc_ms.spice

# The liberty format file containing standard cell timing and function information
set libertyfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_ms/lib/sky130_fd_sc_ms__ff_n40C_1v95.lib
...
set techleffile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_ms/techlef/sky130_fd_sc_ms__nom.tlef
...
set gdsfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_ms/gds/sky130_fd_sc_ms.gds	;# GDS database of standard cells
set verilogfile=/usr/local/share/pdk/sky130A/libs.ref/sky130_fd_sc_ms/verilog/sky130_fd_sc_ms.v	;# Verilog models of standard cells
